...
const assessments = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "multiple_choice" as const,
        options: ["Structured Query Language", "Sequential Query Logic", "System Query Layer", "Simple Queue List"],
        correctOption: 0,
        points: 10,
      },
      {
      ...
      },
      {
        ...
        type: "multiple_choice" as const,
        options: ["Store sorted data", "Enable O(1) average lookup by key", "Traverse elements in order", "Balance binary trees"],
        correctOption: 1,
        points: 10,
      },
      {
        questionId: "c6",
        text: "Write a brief description of what recursion is and give a real-world analogy.",
      ...
      {
        questionId: "c8",
        text: "What is the difference between an interface and an abstract class? Write your answer below.",
        type: "short_answer" as const,
        options: null,
        correctOption: null,
        points: 20,
  ...
  },
  {
    ...
    questions: [
      ...
      {
        questionId: "a4",
        text: "A project takes 8 people 12 days to complete. How many days would it take 16 people?",
        type: "multiple_choice" as const,
      ...
      {
        questionId: "a5",
        text: "What comes next in the pattern? Circle, Triangle, Square, Pentagon, ?",
        type: "multiple_choice" as const,
        options: ["Hexagon", "Heptagon", "Octagon", "Rectangle"],
        correctOption: 0,
        points: 15,
      },
      {
        questionId: "a6",
        text: "Describe a situation where you used logical reasoning to solve a complex problem. What was your approach?",
        type: "short_answer" as const,
        options: null,
        correctOption: null,
        points: 25,
  ...
  },
  {
    ...
    questions: [
      {
        questionId: "t1",
        text: "Which HTTP method is idempotent and used to retrieve data?",
        type: "multiple_choice" as const,
      ...
      },
      {
        ...
        options: [
          ...
          "Cache, API, Protocol - a trilemma for web services",
          "Compute, Access, Processing - fundamental cloud constraints",
          "Concurrent, Atomic, Persistent - ACID properties for databases",
        ],
        correctOption: 0,
        points: 15,
      },
      ...
      {
        questionId: "t4",
        text: "In REST APIs, what does HTTP status code 401 mean?",
        type: "multiple_choice" as const,
        options: ["Not Found", "Internal Server Error", "Unauthorized", "Bad Request"],
        correctOption: 2,
        points: 10,
      },
      {
      ...
      },
      {
        ...
        type: "multiple_choice" as const,
        options: ["Observer", "Builder", "Factory", "Singleton"],
        correctOption: 1,
        points: 10,
      },
      {
        questionId: "t7",
        text: "Design a URL shortening service like bit.ly. Describe the key components and how they interact.",
        type: "short_answer" as const,
        options: null,
        correctOption: null,
        points: 20,
