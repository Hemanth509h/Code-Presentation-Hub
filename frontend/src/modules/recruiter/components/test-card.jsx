...
import { ChevronDown, ChevronRight, CheckCircle2, XCircle, Trash2, Send, MessageSquare } from "lucide-react";
...
export function TestCard({ test, onRefresh, onDelete }) {
  ...
  return (
    <Card className="overflow-hidden">
                      ...
                      {details.assignments.map((a) => (
                        <tr key={a.candidateId} className="border-b last:border-0">
                          ...
                          <td className="py-2 text-right">
                            ...
                            <button onClick={() => setActiveChatCandidate(a.candidateId)} className="p-1 rounded hover:bg-secondary text-primary transition-colors" title="Message Candidate">
      ...
      {activeChatCandidate && (
        <ChatBox
          customTestId={test.customTestId}
